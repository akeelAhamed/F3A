...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 12, 2020 at 01:54 AM
...
CREATE TABLE IF NOT EXISTS `apply` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_vacancy_apply_id` (`vacancy_id`),
  KEY `fk_apply_candidate` (`candidate_id`)
...
INSERT INTO `apply` (`id`, `candidate_id`, `vacancy_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 14, 1, '2020-06-12 01:07:15', '2020-06-12 01:07:15');
...
CREATE TABLE IF NOT EXISTS `candidate` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='All candidate(user) details';
...
(1, 1, 1, 2, '10+', '', 'web developer', '5', '', '2020-01-03', '5', '2019-12-09 02:30:41', '2020-06-11 10:29:12'),
(2, 1, 2, 6, '3-5', '', 'full stack web developer', '8', '', '2020-01-22', '', '2019-12-09 02:30:41', '2020-06-11 10:29:44'),
(4, 2, 1, 2, 'Fresher', '', 'developer', '3', '', '2019-12-11', '', '2019-12-10 02:49:50', '2020-06-11 10:29:50'),
(6, 2, 1, 1, '1-3', 'bsc cs', 'web developer', '9', '', '2020-01-31', '', '2019-12-21 02:02:21', '2020-06-11 10:29:12'),
(7, 2, 7, 17, 'Fresher', 'MBA', 'web developer', '1', '', '2020-01-05', '', '2020-01-02 11:00:11', '2020-06-11 10:29:12'),
(8, 3, 6, 14, 'Fresher', 'BE ', 'web developer', '1', '', '2020-01-07', '', '2020-01-02 11:47:25', '2020-06-11 10:29:12'),
(9, 3, 2, 5, 'Fresher', 'asd', 'web developer', '23', '', '2020-01-08', 'dfsfsd', '2020-01-02 11:57:08', '2020-06-11 10:29:12'),
(11, 2, 2, 5, 'Fresher', 'Hsk', 'web developer', '46', '', '2020-01-23', 'Shjr', '2020-01-04 15:44:04', '2020-06-11 10:29:12'),
(12, 5, 7, 17, '3-5', 'MBA', 'web developer', '2', '', '2020-03-31', 'HR and Liasons', '2020-03-11 13:30:59', '2020-06-11 10:29:12'),
(13, 5, 6, 16, '3-5', 'Diploma', 'web developer', '3', '', '2020-03-31', 'Water Treatmment field', '2020-03-11 13:34:19', '2020-06-11 10:28:55'),
(14, 6, 1, 1, 'Fresher', 'MBA', 'web developer', '1', 'Rs.100000 - Rs.150000', '2020-06-14', 'test', '2020-06-09 08:27:26', '2020-06-11 10:29:12');
...
--
ALTER TABLE `apply`
  ADD CONSTRAINT `fk_apply_candidate` FOREIGN KEY (`candidate_id`) REFERENCES `candidate` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_vacancy_apply_id` FOREIGN KEY (`vacancy_id`) REFERENCES `vacancy` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
